        ...
        <div className="w-11/12 md:w-5/6 mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-700 text-base leading-relaxed">
              ...
              the people who matter most. Whether you're launching a campaign or
              creating everyday brand moments, influencer content delivers
              unmatched authenticity and relatability.
            </p>
            <p className="text-gray-700 text-base leading-relaxed">
