  ...
  return (
    <div className="pt-24 md:pt-32 bg-white min-h-screen text-black">
      ...
      <div className=" pb-10 pt-10 px-4 sm:px-8 max-w-5xl mx-auto">
        ...
        <p className="mb-6">
          Welcome to the website of Bigwig Media Digital. By accessing or using
          our website or services, you agree to comply with and be bound by the
        ...
        <section className="mb-6">
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>General Use:</strong> This site and all materials provided
              (excluding third-party materials) are the property of Bigwig Media
              Digital and protected by copyright laws. You agree not to copy,
              modify, distribute, or exploit any content without prior consent.
            </li>
            <li>
            ...
            <li>
              ...
              Media Digital does not endorse, guarantee, or accept liability for
              third-party information, products, or services. Use at your own
              risk.
            </li>
            <li>
            ...
            <li>
              <strong>Limitation of Liability:</strong> Bigwig Media Digital is
              not liable for any damages arising from the use or inability to
              use our website or services, including lost profits, data loss, or
              business interruption.
            </li>
            <li>
              <strong>Indemnity: </strong> You agree to indemnify and hold
              harmless Bigwig Media Digital from any claims or losses resulting
              from your use of the website or violation of these terms.
            </li>
            <li>
              <strong>Changes: </strong> Bigwig Media Digital reserves the right
              to update these terms at any time. Continued use of the website
              signifies your acceptance of any changes. Bigwig Media Digital
              also reserves the right to change these terms and conditions at
            ...
            <li>
              ...
              non-refundable. Work completed up to cancellation will be billed.
            </li>
            <li>
              <strong>Website Development: </strong> Clear project briefs must
              be provided. Changes after proposal approval may incur additional
              fees. Delays in content delivery or third-party integration may
              affect timelines.
            </li>
            <li>
              <strong>Hosting and Domains: </strong> PClients are responsible
              for timely renewal of hosting and domains. Bigwig Media Digital is
              not liable for data loss due to non-payment. Hosting is managed
              through third-party providers.
            </li>
            <li>
              <strong>Maintenance Plans: </strong> Maintenance packages are
              billed quarterly and cover minor updates only. Unused hours do not
              roll over. Extra hours are billed separately.
            </li>
            <li>
            ...
            <li>
              ...
              parties agree not to solicit or hire each other's employees for 24
              months after project completion. Confidentiality of shared
              information must be maintained.
            </li>
            <li>
              <strong>Governing Law: </strong> This agreement is governed by
              Indian law and any disputes will be resolved in New Delhi courts.
            </li>
            <li>
