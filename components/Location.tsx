...
type Location = {
  ...
  address: string;
  image: string;
  mapUrl: string; // Added map URL per location
};
...
const locations: Location[] = [
  ...
  //   mapUrl: "https://www.google.com/maps/place/Dubai", // placeholder
  // },
  {
    city: "Delhi",
    ...
    mapUrl: "https://maps.app.goo.gl/UxoWwYXBFKHmXfgP6", // placeholder
  },
  {
    city: "Australia",
    ...
    mapUrl: "https://maps.app.goo.gl/tRCezdMET47G8x9G8", // placeholder
  },
  {
    city: "New Zealand",
    ...
    mapUrl: "https://maps.app.goo.gl/C8LuG1hYk5ejkxX97", // placeholder
  },
];
